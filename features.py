...
amr_special_frame_dictionary = [
    ...
    'street-address-91',
    # constructions
    'correlate-91',# ("the more the merrier")
    'have-degree-of-resemblance-91', # ("X is more like Y than Z")
    # math
    'statistical-test-91',
    'value-interval',
    'variable',
...
amr_entity_type_dictionary = [
    'thing', # (thing is the most general type)
    # people
    'person',
    'family',
    'animal',
